...
<div class="col-sm-8">
	...
	<form method="POST" action="process_admin_cours_professeurs.php">
		<div class="row">
			<div class="col-sm-4">
			...
			<div class="col-sm-12">
				<button class="bloc-button btn   btn-lg btn-bouton-gris" type="submit">
					<span class="ion ion-checkmark-round icon-anti-flash-white icon-spacer"></span>Ajouter mon professeur
				</button>
			</div>
		</div>
	</form>
